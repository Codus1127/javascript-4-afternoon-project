...
// let user = new User('Gary', 'blaladf');
...
/*
 ...
 Use the "new" keyword to assign context to "this", and save the instance to a
variable named animal1.  You can pass anything you want in for name, species and food.
*/
...
//Code Here
let animal1 = new Animal('bob', 'tiger', 'antelope')


////////// PROBLEM 3 //////////

/*
  Use the bind method to assign context of the "this" keyword in the sayHi function 
  to the user object; and save the bound function to a variable named whoSaysHi.  
*/
...
/*
  here we have a function that just returns the "this" keyword.  We will give context to
  "this", and your job is to tell us what the context is.
*/
